<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">Nuevo Cliente</h2></x-slot>
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('clientes.store') }}" class="bg-white p-6 rounded shadow space-y-3">
                @csrf
                ...
                <div class="flex gap-2 justify-end">
                    <a href="{{ route('clientes.index') }}" class="px-4 py-2 border rounded">Cancelar</a>
