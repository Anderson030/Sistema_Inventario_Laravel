    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-2xl font-bold dark:text-slate-100">Clientes</h1>
                    ...
                    <tbody class="text-slate-900 dark:text-slate-100">
                        @forelse($clientes as $c)
                            <tr class="{{ $loop->odd ? 'dark:bg-slate-900' : 'dark:bg-slate-950' }} hover:dark:bg-slate-800 transition-colors">
                                ...
                                <td class="p-2 border border-slate-200 dark:border-slate-800">{{ $c->documento }}</td> {{-- mostramos como RUT --}}
